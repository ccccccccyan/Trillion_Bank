...
<html>
	<head>
 	...
 	<script>
        const terms = {
            1: '<h2>적금거래 기본약관</h2><h3>제1장 총칙</h3><h3>&nbsp제1조 (목적)</h3>본 약관은 일조은행(이하 "본 은행"이라 한다)과 고객 간의 적금 거래에 관한 제반 사항을 규정함으로써, 거래의 명확성 및 투명성을 확보함을 목적으로 한다.<h3>&nbsp제2조 (용어의 정의)</h3>"적금"이라 함은 고객이 본 은행에 금전을 예치하고 본 은행이 이를 수취하는 것을 말한다.\n"고객"이라 함은 본 은행과 적금 거래를 하는 개인 또는 법인을 말한다.\n"본 은행"이라 함은 본 약관에 따라 적금 거래를 수행하는 금융기관을 말한다.<h3>&nbsp제3조 (약관의 효력 및 변경)</h3>본 약관은 본 은행과 고객 간의 적금 거래에 적용된다.\n본 은행은 필요한 경우 본 약관을 변경할 수 있으며, 변경된 약관은 본 은행의 영업점 및 인터넷 홈페이지에 게시함으로써 효력이 발생한다.고객이 변경된 약관에 동의하지 않는 경우, 고객은 적금을 해지할 수 있다.<h3>제2장 적금의 개설 및 관리</h3><h3>&nbsp제4조 (적금의 개설)</h3>적금을 개설하고자 하는 고객은 본 은행이 정한 절차에 따라 계좌 개설 신청서를 제출하여야 한다.\n본 은행은 필요 시 고객에게 신원 확인을 위한 서류를 요구할 수 있다.<h3>&nbsp제5조 (적금의 관리)</h3>고객은 본 은행의 지시에 따라 적금을 관리하여야 하며, 적금의 입출금 및 잔액 조회는 본 은행이 정한 방법에 따른다.\n본 은행은 고객의 적금을 안전하게 관리할 의무가 있으며, 고객의 요청에 따라 적금 관련 정보를 제공한다.<h3>제3장 적금의 입금 및 출금</h3><h3>&nbsp제6조 (입금)</h3>고객은 본 은행이 정한 방법에 따라 적금을 입금할 수 있다.\n입금된 금액은 본 은행이 확인한 시점부터 적금으로 인정된다.<h3>&nbsp제7조 (출금)</h3>고객은 본 은행이 정한 방법에 따라 적금을 출금할 수 있다.\n본 은행은 고객의 신원 확인을 위해 출금 시 필요한 서류를 요구할 수 있다.<h3>제4장 적금의 해지 및 정산</h3><h3>&nbsp제8조 (적금의 해지)</h3>고객은 본 은행이 정한 절차에 따라 적금을 해지할 수 있다.\n적금 해지 시 본 은행은 고객에게 적금 잔액을 지급한다.<h3>&nbsp제9조 (적금의 정산)</h3>적금이 해지된 경우, 본 은행은 해지일까지의 이자를 포함한 적금 잔액을 고객에게 지급한다.\n본 은행은 적금 해지 시 발생하는 수수료를 공제할 수 있다.<h3>제5장 기타</h3>\n<h3>&nbsp제10조 (면책사항)</h3>\n본 은행은 천재지변, 전쟁, 테러, 정부의 명령 등 불가항력적인 사유로 인한 적금 거래의 지연 또는 불이행에 대해 책임지지 않는다.<h3>&nbsp제11조 (분쟁 해결)</h3>\n본 은행과 고객 간의 적금 거래로 인한 분쟁은 본 은행의 본점 소재지를 관할하는 법원을 제1심 관할 법원으로 한다.',
            2: '<h2>제1장: 적금의 종류</h2><h3>제1조 (적금의 정의)</h3>\n일조은행은 다양한 종류의 적금을 제공합니다. 적금이란 고객이 일조은행에 자금을 예치하고 이를 일정 기간 동안 보관하며, 그에 따른 금융서비스를 제공받을 수 있는 금융상품을 말합니다.<h3>제2조 (적금의 종류)</h3>적금의 종류는 다음과 같습니다.가. 보통적금: 일조은행에 예치한 금액을 언제든지 인출할 수 있는 적금으로, 일반적인 금융거래에 사용됩니다.나. 적금: 정기적으로 일정 금액을 예치하고 이에 대해 정해진 기간 동안 일정한 이자를 지급받을 수 있는 적금으로, 장기적인 금융 계획에 유리합니다.다. 예적금: 일정 기간 동안 예치한 금액에 대해 미리 약정된 금리를 적용받는 적금으로, 안정적인 이자 수익을 추구하는 고객에게 적합합니다.<h3>제3조 (적금의 이자율)</h3>\n적금의 종류에 따라 적용되는 이자율은 일조은행의 정책에 따라 다를 수 있으며, 고객은 이를 언제든지 확인할 수 있습니다.<h3>제4조 (적금의 인출 및 해지)</h3>적금의 인출 및 해지는 일조은행의 영업점에서 신분증을 제시하여 가능합니다. 단, 일부 적금 상품에는 일정 기간 후에 해지할 수 있는 조건이 존재할 수 있습니다.<h3>제2장: 적금의 운용</h3><h3>제5조 (적금의 운용)</h3>적금의 운용은 고객의 요구에 따라 다양한 금융서비스를 제공합니다. 적금에 대한 잔액 조회, 이체, 자동이체 등의 서비스를 무료로 제공합니다.<h3>제6조 (적금의 보호)</h3>\n일조은행은 금융감독원의 지침에 따라 적금을 보호하고 있으며, 법적으로 정해진 보호대상에 포함됩니다.<h3>제3장: 기타</h3><h3>제7조 (약관의 변경)</h3>\n일조은행은 필요한 경우 본 약관을 변경할 수 있으며, 변경 사항은 고객에게 사전에 공지합니다.<h3>제8조 (분쟁의 해결)</h3>적금거래에 관한 분쟁이 발생할 경우, 일조은행과 고객은 상호 협의하여 원만히 해결하도록 합니다. 해결이 어려운 경우, 관련 법령과 일조은행의 내부규정에 따라 해결합니다.',
            3: '<h2>일조은행 상품설명서</h2><h3>적금거래 기본약관</h3><h3>제1장 총칙</h3><h3>제1조 (목적)</h3><p>본 약관은 일조은행(이하 "본 은행"이라 한다)과 고객 간의 적금 거래에 관한 제반 사항을 규정함으로써, 거래의 명확성 및 투명성을 확보함을 목적으로 한다.</p><h3>제2조 (용어의 정의)</h3><ul><li>"적금"이라 함은 고객이 본 은행에 금전을 예치하고 본 은행이 이를 수취하는 것을 말한다.</li><li>"고객"이라 함은 본 은행과 적금 거래를 하는 개인 또는 법인을 말한다.</li><li>"본 은행"이라 함은 본 약관에 따라 적금 거래를 수행하는 금융기관을 말한다.</li></ul><h3>제3조 (약관의 효력 및 변경)</h3><p>본 약관은 본 은행과 고객 간의 적금 거래에 적용된다. 본 은행은 필요한 경우 본 약관을 변경할 수 있으며, 변경된 약관은 본 은행의 영업점 및 인터넷 홈페이지에 게시함으로써 효력이 발생한다. 고객이 변경된 약관에 동의하지 않는 경우, 고객은 적금을 해지할 수 있다.</p><h3>제2장 적금의 개설 및 관리</h3><h3>제4조 (적금의 개설)</h3><p>적금을 개설하고자 하는 고객은 본 은행이 정한 절차에 따라 계좌 개설 신청서를 제출하여야 한다. 본 은행은 필요 시 고객에게 신원 확인을 위한 서류를 요구할 수 있다.</p><h3>제5조 (적금의 관리)</h3><p>고객은 본 은행의 지시에 따라 적금을 관리하여야 하며, 적금의 입출금 및 잔액 조회는 본 은행이 정한 방법에 따른다. 본 은행은 고객의 적금을 안전하게 관리할 의무가 있으며, 고객의 요청에 따라 적금 관련 정보를 제공한다.</p><h3>제3장 적금의 입금 및 출금</h3><h3>제6조 (입금)</h3><p>고객은 본 은행이 정한 방법에 따라 적금을 입금할 수 있다. 입금된 금액은 본 은행이 확인한 시점부터 적금으로 인정된다.</p><h3>제7조 (출금)</h3><p>고객은 본 은행이 정한 방법에 따라 적금을 출금할 수 있다. 본 은행은 고객의 신원 확인을 위해 출금 시 필요한 서류를 요구할 수 있다.</p><h3>제4장 적금의 해지 및 정산</h3><h3>제8조 (적금의 해지)</h3><p>고객은 본 은행이 정한 절차에 따라 적금을 해지할 수 있다. 적금 해지 시 본 은행은 고객에게 적금 잔액을 지급한다.</p><h3>제9조 (적금의 정산)</h3><p>적금이 해지된 경우, 본 은행은 해지일까지의 이자를 포함한 적금 잔액을 고객에게 지급한다. 본 은행은 적금 해지 시 발생하는 수수료를 공제할 수 있다.</p><h3>제5장 기타</h3><h3>제10조 (면책사항)</h3><p>본 은행은 천재지변, 전쟁, 테러, 정부의 명령 등 불가항력적인 사유로 인한 적금 거래의 지연 또는 불이행에 대해 책임지지 않는다.</p><h3>제11조 (분쟁 해결)</h3><p>본 은행과 고객 간의 적금 거래로 인한 분쟁은 본 은행의 본점 소재지를 관할하는 법원을 제1심 관할 법원으로 한다.</p>',
        	...
        	5: '<h2>계좌간 자동이체/인터넷뱅킹 연결계좌 서비스 이용약관</h2><h3>1. 서비스 개요</h3><h3>1.1 서비스 내용</h3><p>계좌간 자동이체/인터넷뱅킹 연결계좌 서비스는 고객이 본인의 일조은행 적금 계좌와 다른 금융기관의 계좌 간에 자동 이체를 설정하거나 인터넷뱅킹을 통해 연결하는 서비스를 말합니다.</p><h3>1.2 서비스 장점</h3><p>고객은 본인의 일조은행 적금 계좌를 연결하여, 만기 시 해당 계좌로 이자를 자동 입금 받거나, 서비스 해제 시에도 본인의 일조은행 계좌로 자동 입금할 수 있습니다.</p><h2>2. 서비스 이용 방법</h2><h3>2.1 계좌 연결</h3><p>고객은 일조은행의 인터넷뱅킹 서비스를 통해 계좌간 자동이체/인터넷뱅킹 연결계좌 서비스를 신청할 수 있습니다. 신청 시 본인 확인 절차를 거치고 설정한 후 서비스를 이용할 수 있습니다.</p><h3>2.2 이용 범위</h3><p>본 서비스는 고객이 일조은행 적금 계좌와 다른 금융기관의 계좌 간 이체를 통해 적금 운용 편의성을 높이는 목적으로 제공됩니다.</p><h2>3. 서비스 종료 및 이체 처리</h2><h3>3.1 서비스 해제</h3><p>고객이 본 서비스를 해제하고자 할 경우, 일조은행의 인터넷뱅킹을 통해 해제 절차를 진행할 수 있습니다. 해제 시, 만기 시 입금했던 이자 및 예치금은 고객이 본인의 일조은행 적금 계좌로 반환됩니다.</p><h3>3.2 만기 이자 입금</h3><p>계좌간 자동이체 서비스를 설정한 고객은 적금의 만기 시점에 해당 계좌로 자동으로 이자를 입금 받을 수 있습니다. 이자 지급은 일조은행의 정책에 따라 처리됩니다.</p>',
        	6: '<h2>적금자 보호 안내</h2><h3>1. 적금자 보호 제도 소개</h3><h3>1.1 적금자 보호의 목적</h3><p>일조은행은 고객의 적금을 안전하게 보호하기 위해 적금자 보호제도를 운영하고 있습니다. 이는 적금자의 이해와 안전성을 최우선으로 하여 적금 거래를 보호하는 데에 목적이 있습니다.</p><h3>1.2 보호 대상</h3><p>적금자 보호 대상에는 일조은행에 예치된 모든 적금이 포함됩니다. 적금 보호 대상 금액은 1인당 최고 5천만원까지 일조은행 적금자 보호 준비금에 의해 보호됩니다.</p><h3>1.3 보호 범위</h3><p>일조은행 적금자 보호 제도는 법적으로 정해진 한도 내에서 적금자의 원금과 이자를 보호합니다. 다만, 보호 대상 금액을 초과하는 부분에 대해서는 보호되지 않을 수 있습니다.</p><h2>2. 적금자 보호 절차</h2><h3>2.1 보호 절차</h3><p>적금자 보호는 일조은행 적금자 보호 준비금에 의해 자동으로 이루어집니다. 이는 고객이 일조은행에 적금을 예치할 경우 자동으로 적용되며, 별도의 신청 절차가 필요하지 않습니다.</p><h3>2.2 보호 범위 외의 예외</h3><p>일조은행 적금자 보호 제도는 일부 예외 사항이 있을 수 있으며, 이는 일조은행의 내부 규정 및 관련 법령에 따라 결정될 수 있습니다. 예를 들어, 특정 금융상품이나 특정 조건을 충족하지 않는 적금은 보호 범위에서 제외될 수 있습니다.</p><h2>3. 추가 정보 및 문의</h2><h3>3.1 보다 자세한 정보</h3><p>적금자 보호에 관한 보다 자세한 정보는 일조은행의 고객센터를 통해 문의하실 수 있습니다. 보호 제도에 대한 이해를 높이고 고객의 안전한 금융 거래를 지원하기 위해 항상 준비되어 있습니다.</p>'
        };
...
<body>
    ...
    <div id="container">
        ...
        <div>
            <input type="checkbox" class="term-check" id="term1" onclick="updateAgreeButton()"> [필수] 적금거래 기본약관 <button onclick="showTerm(1)">보기</button>
        </div>
        <div>
            <input type="checkbox" class="term-check" id="term2" onclick="updateAgreeButton()"> [필수] 적금거래종류 기본약관 <button onclick="showTerm(2)">보기</button>
        </div>
        <div>
