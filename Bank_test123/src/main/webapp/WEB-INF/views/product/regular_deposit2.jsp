...
<body>
    ...
    <div class="link-all">
        ...
        <br><br>
        <button class="confirmation" onclick="location.href='product_insert.do?idx='+${param.idx}">상품가입</button>
        </div>
        ...
        <div id="product-info-details" class="info-details" style="display:none;">
            <h2>상품정보</h2>
            <p>일정기간 동안 일정금액을 은행에 예치하고 그 기간이 만료한때에 이자와 원금을 지급하는 거치식 예금</p>
            <h2>가입대상</h2>
            <p>제한없음</p>
            <h2>가입금액</h2>
            <p>5000만원</p>
            ...
            <h2>유의사항</h2>
            <ul><li style="list-style: disc;">이 예금은 일조은행법에 따라, 본 일조은행에 있는 귀하의 모든 예금보호 대상 금융상품의 원금과 소정의
            이자를 합하여 1인당 "최고 5천만원까지" 일조은행 예금자보호준비금에 의해 보호되며, 5천만원 초과 금액에 대해서는 보호되지 않습니다.</li>
