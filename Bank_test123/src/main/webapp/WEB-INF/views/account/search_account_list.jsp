...
<link rel="stylesheet" type="text/css"
   ...
   <style>
      ...
      .transaction-header {
         ...
         /* Add this to space out the header items */
      }
      ...
      .back-button.adjusted {
         margin-right: 10px; /* Adjust the right margin for positioning */
      }
   ...
   <form>
            ...
            <c:choose>
               ...
               <c:when test="${type == '입금'}">
                  ...
                  <c:if test="${vo2.account_number != vo.account_number}">
                     <div class="transaction-item">
                        <div class="transaction-party">${vo2.user_name}</div>
               ...
               <c:when test="${type == '출금'}">
                  ...
                  <c:if
                     test="${vo2.depo_username != null && vo2.account_number == vo.account_number}">
                     <div class="transaction-item">
                        <div class="transaction-party">${vo2.depo_username}</div>
      ...
      <div class="button-container">
         <a href="javascript:history.back()" class="back-button">조회기간변경</a>
         <a href="account_info.do?account_number=${vo.account_number}" class="back-button">목록</a>
      </div>
   </form>
</body>
</html>