...
<html>
    ...
    <div id="header">
        ...
        <div class="container">
            ...
            <h2>제1조 (목적)</h2>
            <p>본 개인정보 처리방침은 <span class="highlight">[Trillion Bank(일조은행)]</span> (이하 "일조은행")이 고객의 개인정보를 처리함에 있어 개인정보 보호법을 준수하고, 고객의 권익을 보호하기 위함을 목적으로 합니다.</p>
            
            <h2>제2조 (개인정보의 수집 항목 및 수집 방법)</h2>
            <p>1. <span class="highlight">수집하는 개인정보의 항목</span></p>
            <div class="definition">
                <p>- 필수항목: 성명, 생년월일, 성별, 연락처(전화번호, 이메일 등), 주소, 계좌번호, 신용카드 정보, 신분증 사본</p>
                <p>- 선택항목: 직업, 소득정보, 가족관계, 기타 고객이 제공하는 정보</p>
            </div>
            <p>2. <span class="highlight">개인정보 수집 방법</span></p>
            <div class="definition">
