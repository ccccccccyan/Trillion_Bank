...
<html>
	<head>
		...
		<script>
			...
			//답변 기능
			function reply(){
				location.href="reply_form.do?q_board_idx=${vo.q_board_idx}&page=${param.page}";
			}
				...
				<tr>
					<td colspan="2">
						...
						<input type="button" value="목록으로"
							   onclick="location.href='list.do?page=${param.page}&search=${param.search}&$search_text=${param.search_text}'"> <!-- 'history.go(-1); 해도 ㄱㅊ' -->
